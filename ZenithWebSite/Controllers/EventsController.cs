...
namespace ZenithWebSite.Controllers
{
    public class EventsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("EventId,EventFrom,EventTo,ActivityId,CreationDate,IsActive")] Event @event)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EventId,EventFrom,EventTo,ActivityId,CreationDate,IsActive")] Event @event)
        {
            if (id != @event.EventId)
            {
                return NotFound();
